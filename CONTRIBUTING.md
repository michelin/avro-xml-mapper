# Contributing to Avro XML Mapper
...
To contribute to Avro XML Mapper:
...
- Open a merge request to the `main` branch of the Avro XML Mapper repository so that we can review your changes
